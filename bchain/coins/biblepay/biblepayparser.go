...
// NewBiblepayParser returns new BiblepayParser instance
...
// the regression test Biblepay network, the test Biblepay network and
// the simulation test Biblepay network, in this order
